...
const AppointmentReject = () => {
        ...
        useEffect(() => {
            const fetchData = async () => {
                ...
                try {
                    const response = await axios.get("http://192.168.73.243:6900/AppointmentBookedAPI/GetAllActiveAppointmentBookedForDentist?Status=Closed", {
                        headers: headers,
                    });
                    if (response.status === 200) {
                        console.log("GetAllRejectAppointmentBookedForDentist request good");
