...
const AppointmentActive = () => {
        ...
        let urlF;
        if(userRole=="\"Patient\""){
            urlF="http://192.168.73.243:6900/AppointmentBookedAPI/GetAllActiveAppointmentBookedForPatient?Status=Active";
        }
        else
            urlF="http://192.168.73.243:6900/AppointmentBookedAPI/GetAllActiveAppointmentBookedForDentist?Status=Active";
        const handelRefresh=()=>{
            setRefresh((prev)=>{
                return prev+1;
            })
