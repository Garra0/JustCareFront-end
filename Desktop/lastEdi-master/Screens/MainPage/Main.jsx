...
const Main = (props) => {
    ...
    <View style={{flexDirection:"row", flex:1, backgroundColor:!darkMood?"#ffff":"#161616" }}>
        ...
        {userRole=="\"Dentist\""&&
                <TouchableOpacity  style={darkMood?styles.smallBoxAprovel:styles.smallBox1DarkAprovel } onPress={()=>{
                    navigation.navigate("Notes");
                    ...
                    >
                        <Text style={darkMood?styles.boxText:styles.DarkboxText}>{language? "مواعيد تحت انتظار الموافقه":"waiting aprovel appointments "}</Text>
                        <Feather name="check-square" size={40} color={darkMood?"#fff":"#161616"}
                         style={{
